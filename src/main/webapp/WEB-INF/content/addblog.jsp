    ...
    <div class="layui-row" style="min-height: 89.6%">
        ...
        <div class="layui-col-xs8">
            <form:form cssClass="layui-form" action="addblog" modelAttribute="blog"
                       cssStyle="width: 1000px;margin-top: 15px" method="post">
                <div class="layui-form-item">
                    <label class="layui-form-label">输入标题</label>
                    <div class="layui-input-block">
                        <form:input type="text" path="title" lay-verify="required" placeholder="请输入标题"
                                    autocomplete="off"
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <form:textarea path="content" placeholder="请输入内容" cssClass="layui-textarea"
                                       cssStyle="height: 465px"></form:textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <div class="layui-input-block">
